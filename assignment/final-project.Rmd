...
We are going to be reading in the CAISO data by each month for 2017 into individual dataframes. 
...
We see that, as expected, solar is the most abundant source during light hours, and then wind takes over at approximately 5pm and 7pm in winter and summer respectively. 
...
This graph of renewable generation averaged over the whole peak and super peak time periods, is a way to more clearly visualize how resources vary throughout the year, both with itself and with the other renewables. 
It is evident that there is a huge disparity between winter and summer output for Solar due to light availability, while geothermal remains a consistent source year-round.  Similarly, Small Hydro is fairly consistent, although it generates much less production.
